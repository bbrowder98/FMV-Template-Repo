...
df = pandas.read_csv(r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_fmv_sequences_vendor.csv')
sequences_df = spark_sequences.createDataFrame(df)
mp4_pd = pandas.read_csv(r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\tabulated\template_fmv_mp4s_tabulated.csv')
mp4_df = spark_mp4.createDataFrame(mp4_pd)
jpeg_pd = pandas.read_csv(r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\tabulated\template_fmv_jpegs_tabulated.csv')
jpegs_df = spark_jpeg.createDataFrame(jpeg_pd)
mapp_pd = pandas.read_csv(r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\tabulated\fmv_mapp_metadata_tabulated.csv')
mapp_df = spark_mapp.createDataFrame(mapp_pd)
seq_pd = pandas.read_csv(r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\tabulated\template_fmv_seq_metadata_tabulated.csv')
seq_df = spark_seq.createDataFrame(seq_pd)

output_path = r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_fmv_vendor_test.csv'

def columns_as_struct(df):
    '''Converts all of the columns of the dataframe as a single struct.'''
    BLACKLIST = ["_filepath", "_batch_path", "_bytes"]  # remove internal use columns
...
def filename(id_col):
    ...
    return r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_vendor_data\\' + id_col + ".json"

@F.udf(T.StringType())
def jpeg_filename(id_col):
    '''Generates the name of the output JSON file when it is created downstream.'''
    return r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_vendor_data\\' + id_col + "_jpeg.zip"

@F.udf(T.StringType())
def mapp_filename(id_col):
    '''Generates the name of the output JSON file when it is created downstream.'''
    return r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_vendor_data\\' + id_col + "_mapp_metadata.json"

@F.udf(T.StringType())
def mp4_filename(id_col):
    '''Generates the name of the output JSON file when it is created downstream.'''
    return r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_vendor_data\\' + id_col + ".mp4"

@F.udf(T.StringType())
def seq_filename(id_col):
    '''Generates the name of the output JSON file when it is created downstream.'''
    return r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_vendor_data\\' + id_col + "_seq_metadata.json"
...
sequences_df.toPandas().to_csv(r'C:\Users\ecsr\Desktop\FMV Data Processing\datasets\vendor\template_fmv_vendor_test.csv', index=False)